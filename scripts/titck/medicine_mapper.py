...
EXPANSION_BRAND_QUERIES: list[tuple[str, str, int]] = [
    ...
    ("Ferrum", "Vitamin ve Mineral", 5),
    ("Ferro Sanol", "Vitamin ve Mineral", 3),
    ("Supradyn", "Vitamin ve Mineral", 3),
    ("Elevit", "Vitamin ve Mineral", 3),
    ("Magnerot", "Vitamin ve Mineral", 2),
    ...
    ("Xyzal", "Alerji", 2),
    ("Singulair", "Solunum", 2),
    ("Glucophage", "Diyabet", 3),
    ("Euthyrox", "Endokrin", 2),
    ("Concor", "Kardiyoloji", 3),
    ("Beloc", "Kardiyoloji", 2),
    ("Ator", "Kardiyoloji", 3),
    ("Crestor", "Kardiyoloji", 2),
    ("Desirel", "Nöroloji", 2),
    ("Spazmol", "Mide", 2),
]

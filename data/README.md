...
| Path | Description |
|------|-------------|
| `database/medicines.csv` | Medicine records (153 drugs, TİTCK-enriched) |
...
Catalog size: **153** seed records (TİTCK SKRS–enriched) — see [Report 24](../docs/reports/24-medicine-database-final-refresh.md), [Report 18](../docs/reports/18-medicine-database-expansion.md), and [database/README.md](database/README.md).

...
Phase 8. It calls analyze_medicine_box() from src/services/ and prints
intermediate OCR candidates, filtered texts, and ranked matches.

For the recommended minimal demo, use:
